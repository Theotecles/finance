...
print(s_and_p_500[20:25])
for symbol in s_and_p_500[20:25]:
    print(symbol)

    url = f'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol={symbol}&outputsize=full&apikey=MYAPIKEY'
    r = requests.get(url)
    data = r.json()
