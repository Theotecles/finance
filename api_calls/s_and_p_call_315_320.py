...
for symbol in s_and_p_500[315:320]:
    print(symbol)

    url = f'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol={symbol}&outputsize=full&apikey=MYAPIKEYZ'
    r = requests.get(url)
    data = r.json()
